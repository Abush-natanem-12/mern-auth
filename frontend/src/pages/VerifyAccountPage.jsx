...
export default function VerifyAccountPage() {
  ...
  return (
    <div className="w-full md:w-[80%] 2xl:w-[70%] mx-auto flex flex-col items-center py-5 gap-4">
      <h1 className="text-xl lg:text-2xl font-bold text-fuchsia-900">
      ...
      <form className="flex flex-col items-center gap-8" onPaste={handlePaste}>
        <div className="w-full flex items-center justify-center gap-3">
          {inputs.map((input, index) => (
            <input
              ...
              className="size-10 lg:size-12 border-[2px] border-fuchsia-900/[.5] outline-none rounded-md shadow-md shadow-fuchsia-900/[.5] text-xl text-white text-center"
            />
          ))}
        </div>
        ...
        <button
          type="submit"
          className="text-base lg:text-xl font-bold tracking-[1px] text-sky-500 bg-fuchsia-800 hover:bg-fuchsia-900 px-2 py-1 
